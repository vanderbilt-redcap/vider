...
define(["require","d3","d3-tip","rugPlotHandler","categoryPlotHndlr","global","filterData"],
    function(require,d3,d3tip,rugPlotHandler,categoryPlotHndlr, global, filterData){
        ...
        $("#left-top").prepend("<div id='scatterPlot' style='margin-left: 15px; margin-right: 15px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; background-color: #8199C9; font-size: 17px; border-radius: 10px; color: white; font-weight: bold;' data-toggle='modal' data-target='#scatterPlotModal'>Add a Scatter Plot</div>");
